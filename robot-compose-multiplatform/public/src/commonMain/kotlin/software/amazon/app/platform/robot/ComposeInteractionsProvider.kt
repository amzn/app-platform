...
/**
 * Provides the [SemanticsNodeInteractionsProvider] that is forwarded to [ComposeRobot]s. This interface is usually
 * implemented by the test class and forwards the Compose test rule.
 */
