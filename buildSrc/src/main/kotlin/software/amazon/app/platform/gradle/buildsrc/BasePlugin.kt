...
public open class BasePlugin : Plugin<Project> {
  override fun apply(target: Project) {
    ...
    target.extensions.configure<KoverProjectExtension>("kover") {
        reports {
            total {
                xml {
                    // Configure XML report generation.
                    // The 'onCheck = true' property would enable it during the 'check' task.
                    // Leaving it empty enables the report with default settings, generated by 'koverXmlReport'.
                }
                html {
                    // Configure HTML report generation.
                    // The 'onCheck = true' property would enable it during the 'check' task.
                    // Leaving it empty enables the report with default settings, generated by 'koverHtmlReport'.
                }
            }
        }
    }
