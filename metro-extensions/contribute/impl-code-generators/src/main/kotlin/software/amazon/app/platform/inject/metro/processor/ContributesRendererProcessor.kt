...
import software.amazon.app.platform.inject.metro.ContextAware
...
internal class ContributesRendererProcessor(
  ...
  private val rendererKey = ClassName("software.amazon.app.platform.renderer.metro", "RendererKey")
...
//            .addOriginAnnotation(clazz)
  ...
  private fun createModelBindingFunction(
    ...
    return FunSpec.builder("provide${clazz.safeClassName}" + modelType.innerClassNames())
      ...
      .addAnnotation(AnnotationSpec.builder(rendererKey)
        .addMember("%T::class", modelType.toClassName())
        .build())
      // fun provideRenderer(
      //      renderer: Provider<RootPresenterRenderer>
      //    ): Renderer<*> = renderer.invoke()
      .addParameter(name = "renderer", type = Provider::class.asClassName().parameterizedBy(clazz.toClassName()))
