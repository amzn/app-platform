...
/**
 * A qualifier to identify the coroutine scope used to run presenters. This scope is commonly injected when converting a
 * `Flow` to a `StateFlow`, see `stateInPresenter` for more details.
 *
 * This scope uses the [MainCoroutineDispatcher] by default, because presenters produce state for the UI and computing
