...
interface UserPagePresenter : MoleculePresenter<Unit, Model> {
  ...
  /**
   * The state of the user page. Note that this class implements [ModelDelegate] to override which [SampleAppTemplate]
   * to use. This Model hosts to other models [listModel] and [detailModel], which will be produced by child presenters.
   */
  data class Model(val listModel: BaseModel, val detailModel: BaseModel) : BaseModel, ModelDelegate {
